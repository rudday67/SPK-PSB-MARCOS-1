...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-users text-primary mr-2"></i>Tambah Data Alternatif
        </h1>
        <p class="text-muted mt-2">Tambahkan alternatif baru</p>
    </div>
...
<div class="card shadow-sm border-0">
    <div class="card-header bg-white py-3 border-bottom">
        <h6 class="m-0 font-weight-bold text-primary">
            <i class="fas fa-plus mr-2"></i>Form Tambah Data Alternatif
        </h6>
    </div>
    <div class="card-body">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <input autocomplete="off" type="text" name="nama" required class="form-control border-primary"/>
            </div>
        </div>
    </div>
